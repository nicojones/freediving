...
must_haves:
  truths:
    - "DayListSection uses plan name and description (not hardcoded 'Training' / 'Focus on rhythmic breathing...')"
    - "TopAppBar no longer shows plan name (redundant with DayListSection)"
    - "App name 'Fishly' lives in src/constants/app.ts"
---
