...
must_haves:
  truths:
    - "App loads training plans from JSON files (day sequences)"
    - "Parsed plans expose hold/breathe intervals per day"
    - "Admin can add or modify plans by updating JSON (no in-app editor)"
